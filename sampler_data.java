...
public class weatherDefaultSampler
{
...
//Partitioner class
   ...
   Partitioner < DoubleWritable, Text >
   {
	 ...
	 double maxLoad=0;
	 maxLoad=maxTemp/numReduceTasks;
	 ...
	 if(temp>=minTemp && temp<(maxLoad*2))
         {
            return 0;
         }
         
         if(temp>= (maxLoad*2) && temp<(maxLoad*4))
         {
            return 1;
         }
         else
	...
	public static void main(String[] args) throws Exception
	{
		...
		j1.setJarByClass(weatherDefaultSampler.class);
